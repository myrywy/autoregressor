...
class DataPipeline:
    ...
    def add_generic_unit_transformation_in_nested_structure(
        ...
        def example_transformation(*args):
            ...
            set_unit_in_example_function(result, args)
            return args
    ...
    def add_structural_transformation(
        ...
        Args:
            transformation_funtion: function that modifies dataset's example
        """
        self._transformations.append(transformation_funtion)
